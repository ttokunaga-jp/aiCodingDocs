...
- B: サービス憲章 `B_SERVICE_CHARTER.md` (責務/非責務とSLOを定義)
- C: 要件定義 (FR/NFR) `C_REQUIREMENTS.md` (機能/非機能をAPI単位で明文化)
- D: インターフェース仕様 (API/Event) `D_INTERFACE_SPEC.md` (OpenAPI+イベントスキーマ)
- E: データモデル `E_DATA_MODEL.md` (スキーマとインデックス/リレーション)
- F: ディレクトリ構造・アーキ原則 `F_ARCHITECTURE.md` (依存方向ルール)
...
- N: 運用・デプロイ概要 `N_OPS_DEPLOY_OVERVIEW.md` (CI/CD・Docker 方針の概要)
